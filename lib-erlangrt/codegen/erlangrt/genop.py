...
class OTP25(OTPConfig):
    ...
    def parse_bif_line(self, line):
        ...
        return Bif(atom=fun, mod=mod, arity=arity, cname=cname, biftype=btype)


class OTP27(OTPConfig):
    def __init__(self):
        super().__init__(
            min_opcode=1,
            max_opcode=183,
